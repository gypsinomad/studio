...
export async function POST(request: Request) {
  try {
    ...
    const activityLog = {
        icon: 'Facebook',
        title: `New Facebook Lead: ${finalLeadPayload.fullName}`,
        description: `From ${finalLeadPayload.companyName}, assigned to ${assignment.userName}.`,
    ...
    await batch.commit();
    console.log(`Created lead, activity log, and follow-up task for lead ${leadRef.id}.`);
