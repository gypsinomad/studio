...
import { z } from 'zod';
import type { ExportOrder, LineItem, Company, Contact, Task } from '@/lib/types';
...
import { PRODUCT_TYPES, INCOTERMS, PAYMENT_TERMS, CONTAINER_TYPES, ICEGATE_STATUSES, EXPORT_ORDER_STAGES } from '@/lib/constants';
    ...
    useEffect(() => {
        if (order && lineItems) {
            form.reset({
                ...
                // @ts-ignore
                expectedShipmentDate: order.expectedShipmentDate?.toDate ? order.expectedShipmentDate.toDate() : order.expectedShipmentDate,
                lineItems: lineItems || [],
            });
        }
...
dueDate: addDays(new Date(), 1),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
            <CardHeader><CardTitle>Shipment Details</CardTitle><CardDescription>Update the main shipment and contact details for this export order.</CardDescription></CardHeader>
